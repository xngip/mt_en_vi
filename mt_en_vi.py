...
for epoch in range(EPOCHS):
    ...
    for (batch, (inp, tar)) in enumerate(dataset):  # Lặp qua các batch dữ liệu
        ...
        if batch % 100 == 0:  # In loss và accuracy sau mỗi 500 batch
            # In loss và accuracy
...
def evaluate_accuracy(dataset):
    ...
    return (total_acc / total_batches).numpy()
...
acc_score = evaluate_accuracy(test_dataset)
