...
def calculate(input_english, transformer, en_tokenizer, vi_tokenizer, ENCODER_LEN, DECODER_LEN):
...
def translation(input_english, transformer, en_tokenizer, vi_tokenizer, ENCODER_LEN, DECODER_LEN):
    vietnamese = calculate(input_english, transformer, en_tokenizer, vi_tokenizer, ENCODER_LEN, DECODER_LEN).numpy()
